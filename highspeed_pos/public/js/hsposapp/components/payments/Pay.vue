    ...
    <v-row v-show="!dialog">
      <v-col md="8" cols="12" class="pb-2 pr-0">
        <v-card class="main mx-auto bg-grey-lighten-5 mt-3 p-3 pb-16 overflow-y-auto"
          ...
          <div v-if="
            pos_profile.hspos_allow_reconcile_payments &&
          ...
          <div v-if="pos_profile.hspos_allow_mpesa_reconcile_payments">
            <v-row>
              <v-col md="8" cols="12">
                <p>
      ...
      <v-col md="4" cols="12" class="pb-3">
        <v-card class="invoices mx-auto bg-grey-lighten-5 mt-3 p-3" style="max-height: 94vh; height: 94vh">
          <strong>
            ...
            <div v-if="pos_profile.hspos_allow_make_new_payments">
...
export default {
  ...
  methods: {
    ...
    get_available_pos_profiles() {
      if (!this.pos_profile.hspos_allow_mpesa_reconcile_payments) return;
      return frappe
        .call(
          "highspeed_pos.highspeed_pos.api.payment_entry.get_available_pos_profiles",
          {
    ...
    get_outstanding_invoices() {
      ...
      return frappe
        .call(
          "highspeed_pos.highspeed_pos.api.payment_entry.get_outstanding_invoices",
          {
    ...
    get_unallocated_payments() {
      if (!this.pos_profile.hspos_allow_reconcile_payments) return;
      ...
      return frappe
        .call(
          "highspeed_pos.highspeed_pos.api.payment_entry.get_unallocated_payments",
          {
            customer: this.customer_name,
            company: this.company,
            currency: this.pos_profile.currency,
    ...
    get_draft_mpesa_payments_register() {
      ...
      return frappe
        .call("highspeed_pos.highspeed_pos.api.m_pesa.get_mpesa_draft_payments", {
          company: vm.company,
    ...
    set_payment_methods() {
      ...
      if (!this.pos_profile.hspos_allow_make_new_payments) return;
    ...
    submit() {
      ...
      payload.hspos_opening_shift_name = this.hspos_opening_shift.name;
      ...
      frappe.call({
        method: "highspeed_pos.highspeed_pos.api.payment_entry.process_pos_payment",
        args: { payload },
        freeze: true,
