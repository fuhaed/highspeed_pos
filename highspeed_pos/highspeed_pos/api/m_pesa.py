...
def confirmation(**kwargs):
    try:
        ...
        doc = frappe.new_doc("HSPOS Mpesa Payment Register")
...
def submit_mpesa_payment(mpesa_payment, customer):
    doc = frappe.get_doc("HSPOS Mpesa Payment Register", mpesa_payment)
