...
from highspeed_pos.highspeed_pos.api.m_pesa import get_token


class HSPOSMpesaC2BRegisterURL(Document):
    def validate(self):
        ...
        validation_url = (
            site_url + "/api/method/highspeed_pos.highspeed_pos.api.m_pesa.validation"
        )
        confirmation_url = (
            site_url + "/api/method/highspeed_pos.highspeed_pos.api.m_pesa.confirmation"
        )
